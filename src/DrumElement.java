 ...
 * Snaps to: 100 (high tom), 125 (mid tom), 150 (floor tom), 200 (bass drum)
 */
public class DrumElement extends AbstractElement {
    
    public static final int[] SNAP_SIZES = {100, 125, 150, 200};
    ...
    public DrawableElement copy() {
        return new DrumElement(x, y, width, new Color(color.getRGB()), rotation, opacity);
    }
    
    // Drums have corner handles for diagonal scaling (1:1 ratio)
    @Override
